 ...
 */
public class _5018_x139A_SHOP_PAY_BILL_EMAIL extends HandlerBase {


    public _5018_x139A_SHOP_PAY_BILL_EMAIL(DanceServer server) {
        super(server);
    }
    ...
    public SendPacket[] handle(ReadPacket packet, DanceClient client) {
        ...
        SendPacket answerPacket = new SendPacket(PacketType.SHOP_RESPONSE_PAY_BILL_EMAIL);
