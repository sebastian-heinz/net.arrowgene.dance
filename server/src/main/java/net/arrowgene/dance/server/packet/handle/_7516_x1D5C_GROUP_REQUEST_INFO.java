...
public class _7516_x1D5C_GROUP_REQUEST_INFO extends HandlerBase {

    public _7516_x1D5C_GROUP_REQUEST_INFO(DanceServer server) {
        super(server);
    }
    ...
    public SendPacket[] handle(ReadPacket packet, DanceClient client) {
        ...
        SendPacket answerPacket = new SendPacket(PacketType.GROUP_RESPONSE_INFO);
