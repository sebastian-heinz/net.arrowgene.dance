...
public class _2035_x7F3_LOBBY_REQUEST_BUDDY_DELETE extends HandlerBase {

    public _2035_x7F3_LOBBY_REQUEST_BUDDY_DELETE(DanceServer server) {
        super(server);
    }
    ...
    public SendPacket[] handle(ReadPacket packet, DanceClient client) {
        ...
        SendPacket answerPacket = new SendPacket(PacketType.LOBBY_RESPONSE_BUDDY_DELETE);

        SocialEntry buddy = null;
