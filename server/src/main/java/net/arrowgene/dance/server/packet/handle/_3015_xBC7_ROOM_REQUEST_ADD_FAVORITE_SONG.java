...
public class _3015_xBC7_ROOM_REQUEST_ADD_FAVORITE_SONG extends HandlerBase {

    public _3015_xBC7_ROOM_REQUEST_ADD_FAVORITE_SONG(DanceServer server) {
        super(server);
    }
    ...
    public SendPacket[] handle(ReadPacket packet, DanceClient client) {
        ...
        // Returning favorite song list seems to work.
