...
public class _6000_x1770_MAIL_REQUEST_MAIL_LIST extends HandlerBase {

    public _6000_x1770_MAIL_REQUEST_MAIL_LIST(DanceServer server) {
        super(server);
    }
    ...
    public SendPacket[] handle(ReadPacket packet, DanceClient client) {
        ...
        ArrayList<Mail> mails = client.getMailbox().getMails();
        Packet answerPacket = MailPacket.getInstance().getMailListPacket(mails);
