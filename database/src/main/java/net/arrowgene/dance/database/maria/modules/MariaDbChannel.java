...
public class MariaDbChannel {

    private MariaDbController controller;
    private MariaDbFactory factory;

    public MariaDbChannel(MariaDbController controller, MariaDbFactory factory) {
    ...
    public List<ChannelDetails> getChannels() throws SQLException {
        ...
        PreparedStatement select = this.controller.createPreparedStatement("SELECT * FROM `dance_channel`;");
